...
3. Enhancement - Added multiple AFIS/Radio position definitions - thanks to @PLM1995 (Peter Mooney)
4. Enhancement - Updated AFIS/Radio position identifier format to xxIN/xxAG - thanks to @PLM1995 (Peter Mooney)
5. Enhancement - Added missing holding point label ('FR') to Gatwick (EGKK) SMR - thanks to @SwietyMik (Mikolaj Huk)
6. Enhancement - Updated the Newcastle (EGNT) SMR to reflect A-SMGCS - thanks to @togaten (Thomas Greer) and @Bucklerz (Reece Buckley)
7. Enhancement - Added London Heliport (EGLW) SMR - thanks to @PLM1995 (Peter Mooney)
8. Enhancement - Added Missing Runways to Alderney (EGJA) - thanks to @JamesBayliss-deGruchy (James Bayliss-de Gruchy)
9. Enhancement - Added Shobdon (EGBS) SMR - thanks to @danielbutton (Daniel Button)
10. Enhancement - Added Shobdon (EGBS) Data - thanks to @danielbutton (Daniel Button)
11. Enhancement - Added Sywell (EGBK) SMR - thanks to @JamesBayliss-deGruchy (James Bayliss-de Gruchy)
12. Enhancement - Added extra runways to Sywell (EGBK) - thanks to @JamesBayliss-deGruchy (James Bayliss-de Gruchy)
13. Enhancement - Added Rochester (EGTO) SMR - thanks to @JamesBayliss-deGruchy (James Bayliss-de Gruchy)
14. Enhancement - Added Rochester (EGTO) runway definitions - thanks to @JamesBayliss-deGruchy (James Bayliss-de Gruchy)
15. Enhancement - Added Tingwall (EGET) SMR - thanks to @JamesBayliss-deGruchy (James Bayliss-de Gruchy)
16. Enhancement - Updated Teesside (EGNV) SMR - thanks to @PLM1995 (Peter Mooney)
...
20. Enhancement - Redrawn Blackbushe (EGLK) SMR - thanks to @danielbutton (Daniel Button)
21. Enhancement - Added Westland (EGHG) SMR to replace old wireframe version - thanks to @danielbutton (Daniel Button)
22. Procedure Change (2204) - Updated EDYY_D_CTR frequency - thanks to @PLM1995 (Peter Mooney)
23. Procedure Change - Reverted temporary Polaris - Stavanger (ENSV) ownership changes - thanks to @hsugden (Harry Sugden)
24. Procedure Change - Changes to TC WELIN -> Sector 28 agreements (event only) - thanks to @hsugden (Harry Sugden)
25. AIRAC (2204) - Updated Norwich (EGSH) runway coordinates - thanks to @SwietyMik (Mikolaj Huk)
26. AIRAC (2204) - Updated EAS NDB coordinates - thanks to @SwietyMik (Mikolaj Huk)
27. AIRAC (2204) - Updated Sumburgh (EGPB) runway heading - thanks to @SwietyMik (Mikolaj Huk)
28. AIRAC (2204) - Updated Benbecula (EGPL) runway coordinates - thanks to @SwietyMik (Mikolaj Huk)
