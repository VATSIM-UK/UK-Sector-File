...
10. AIRAC (1912) - UL9 reroute - thanks to @JaRm22 (James Morrissey)
11. Enhancement - Update Worthing->S23 agreement for Cardiff (EGFF) inbounds - thanks to @artturnip (Adam Turner)
12. Bug - Removed Church Fenton (EGXG), redesignated as Leeds East (EGCM) in 2013 - thanks to @cbyworth (Chad Byworth)
13. AIRAC (1912) - Updated N862 and Added NEZZA - thanks to @tszczypinski6 (Tom Szczypinski)
14. Bug - Tilstock (EGCT) name/position/frequency corrected - thanks to @cbyworth (Chad Byworth)
15. Bug - Corrected spelling of UNURO waypoint on N864 - thanks to @artturnip (Adam Turner)
16. Bug - Deleted duplicate conventional airways - thanks to @artturnip (Adam Turner)
17. Bug - Add missing agreements for LL GOGSI/GASGU outbounds - thanks to @artturnip (Adam Turner)
18. Bug - Fixed TCNW->Daventry overriding TCSE->Dover agreements - thanks to @artturnip (Adam Turner)
